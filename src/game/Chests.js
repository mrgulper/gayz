...
export const LOOT_WEIGHTS = { health: 1, ammo: 1, noisemaker: 0.4, scope: 0.2, extended_mag: 0.3, fuelcan: 0.5, grenade: 0.35, melee_bat: 0.15, melee_machete: 0.15, melee_uvbaton: 0.1, melee_fireaxe: 0.1, melee_sledgehammer: 0.08, weapon_charm: 0.3, ration: 0.6, rare_weapon: 0.25, legendary_weapon: 0.08 }
const LOOT_LABELS = { health: 'Health Pack', ammo: 'Ammo Crate', noisemaker: 'Noisemaker', scope: 'Scope', extended_mag: 'Extended Mag', fuelcan: 'Fuel Can', grenade: 'Grenade', melee_bat: 'Bat', melee_machete: 'Machete', melee_uvbaton: 'UV Baton', melee_fireaxe: 'Fire Axe', melee_sledgehammer: 'Sledgehammer', weapon_charm: 'Weapon Charm', ration: 'Ration', rare_weapon: 'Rare Weapon Part', legendary_weapon: 'Legendary Weapon Part' }
