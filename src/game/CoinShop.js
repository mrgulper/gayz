...
export const COIN_SHOP_ITEMS = [
  ...
  { id: 'skin_ember', titleKey: 'coinShopEmberSkin', cost: 150, section: 'skins', skin: 'ember' },
  { id: 'skin_gold', titleKey: 'skinGold', cost: 120, section: 'skins', skin: 'gold' },
  { id: 'skin_crimson', titleKey: 'skinCrimson', cost: 120, section: 'skins', skin: 'crimson' },
  { id: 'skin_cobalt', titleKey: 'skinCobalt', cost: 120, section: 'skins', skin: 'cobalt' },
  { id: 'skin_obsidian', titleKey: 'skinObsidian', cost: 120, section: 'skins', skin: 'obsidian' },
  {
    id: 'coin_damage',
